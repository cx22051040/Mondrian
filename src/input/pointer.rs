...
impl GlobalData {
    pub fn on_pointer_motion<I: InputBackend>(&mut self, event: I::PointerMotionEvent) {
        ...
        let under = self.surface_under(position, serial);
        ...
        if pointer_locked {
            ...
            let new_under = self.surface_under(clamp_position, serial);
    ...
    fn surface_under(&mut self, position: Point<f64, Logical>, serial: Serial) -> Option<(WlSurface, Point<f64, Logical>)> {
        // TODO: remove clone
