...
impl PointerGrab<NuonuoState> for ResizeSurfaceGrab {
  ...
  fn motion(
    ...
    _focus: Option<(<NuonuoState as smithay::input::SeatHandler>::PointerFocus, smithay::utils::Point<f64, Logical>)>,
  ...
  fn relative_motion(
    ...
    data: &mut NuonuoState,
    handle: &mut smithay::input::pointer::PointerInnerHandle<'_, NuonuoState>,
    focus: Option<(<NuonuoState as smithay::input::SeatHandler>::PointerFocus, smithay::utils::Point<f64, Logical>)>,
